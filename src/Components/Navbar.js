...
const Navbar = () => {
  ...
  const { query, setQuery, handleUnsplashSearch, handlePixabaySearch } = useDataContext()
  return (
    <>
      <div className='w-full h-[50vh] bg-gradient-to-r flex flex-col  items-center from-indigo-500 via-purple-500 to-pink-500 pt-24 gap-y-6'>
        ...
        <div className='flex justify-center gap-x-3 md:w-[50vw] h-[20%] w-[85vw] mx-auto'>
          ...
          <button onClick={() => { handleUnsplashSearch(); handlePixabaySearch(); }} className='rounded-full  bg-white w-[15%] px-4  focus:outline-blue-600 h-[90%] lg:w-fit'><AiOutlineSearch /></button>
