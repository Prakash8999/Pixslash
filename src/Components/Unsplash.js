...
const Unsplash = () => {
    ...
    useEffect(() => {
        //   let YOUR_ACCESS_KEY = 'dbHrIB6rUFtHFnbMOSuXfzpPD8hCbJvHXHNxu57a170'

        axios(`https://api.unsplash.com/photos?page=1&per_page=18&client_id=dbHrIB6rUFtHFnbMOSuXfzpPD8hCbJvHXHNxu57a170`, {
            method: "GET"
